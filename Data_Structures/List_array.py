...
class List:
    ...
    def combine(self, source1, source2):
        ...
        source1._values.clear()
        source2._values.clear()
    ...
    def count(self, key):
        ...
        -------------------------------------------------------
        """
        count = sum(1 for item in self._values if item == key)
    ...
    def find(self, key):
        ...
        return self._values[index] if index != -1 else None
    ...
    def intersection(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        common_values = set(source1._values) & set(source2._values)
    
    # Clear the underlying list of the current instance
        self._values.clear()
    ...
    def union(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        unique_values = set(source1._values) | set(source2._values)
        
        self._values = list(unique_values)
        return
