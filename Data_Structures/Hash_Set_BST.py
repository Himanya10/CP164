...
class Hash_Set:
    ...
    def find(self, key):
        ...
        """
        slot = self._find_slot(key)
        value = self._table[slot].find(key) if key in self._table[slot] else None
        return value
    ...
    def __eq__(self, target):
        ...
        if self._count == target._count:
            equals = all(value in target for bst in self._table for value in bst)
        return equals
