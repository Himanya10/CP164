...
class Hash_Set:
    ...
    def __contains__(self, key):
        ...
        return key in self._table[slot]
    ...
    def insert(self, value):
        ...
        while i < len(self._table[slot]) and self._table[slot][i] < value:
            i += 1
            
        if i < len(self._table[slot]) and self._table[slot][i] == value:
            inserted  = False
            ...
            self._table[slot].insert(i, value)
    ...
    def __eq__(self, target):
        ...
        if self._count == target._count:
            equals = all(value in target for slot in self._table for value in slot)
        return equals
