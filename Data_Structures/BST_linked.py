...
class BST:
    ...
    def _delete_node_left(self, parent):
        ...
        if parent._right._right is None:
            # parent._right contains the largest value in the left subtree.
            repl_node = parent._right
            parent._right = parent._right._left
        else:
            # Search for the largest value in the right subtree of parent._right.
    ...
    def _inorder_aux(self, node, a):
        """
        -------------------------------------------------------
        Private helper method to perform inorder traversal.
        -------------------------------------------------------
        Parameters:
            node - a bst node (_BST_Node)
            a - list to store the inorder traversal (list of ?)
        -------------------------------------------------------
        """
        if node is not None:
    ...
    def _preorder_aux(self, node, a):
        """
        -------------------------------------------------------
        Private helper method to perform preorder traversal.
        -------------------------------------------------------
        Parameters:
            node - a bst node (_BST_Node)
            a - list to store the preorder traversal (list of ?)
        -------------------------------------------------------
        """
        if node is not None:
            a.append(node._value)
    ...
    def _postorder_aux(self, node, a):
        """
        -------------------------------------------------------
        Private helper method to perform postorder traversal.
        -------------------------------------------------------
        Parameters:
            node - a bst node (_BST_Node)
            a - list to store the postorder traversal (list of ?)
        -------------------------------------------------------
        """
        if node is not None:
